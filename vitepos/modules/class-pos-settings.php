...
class POS_Settings extends BaseModule {
	...
	public function client_header() {
		...
		$links = array(
			array(
				'href' => $this->get_plugin_url( 'assets/font.css' ),
				'rel'  => 'stylesheet',
			),
			array(
				'href' => $this->get_plugin_url( 'templates/pos-assets/css/color-' . $pos_color . '.css' ),
				'rel'  => 'stylesheet',
			),
			array(
				'href' => $this->get_plugin_url( 'templates/pos-assets/css/vitepos.css' ),
				'rel'  => 'preload',
				'as'   => 'style',
			),
			array(
				'href' => $this->get_plugin_url( 'templates/pos-assets/js/vitepos.js' ),
				'rel'  => 'preload',
				'as'   => 'script',
			),
			array(
	...
	public function client_footer() {
		$links = array(
			array(
				'src' => $this->get_plugin_url( 'templates/pos-assets/js/vitepos.js' ),
			),
		);
		foreach ( $links as $link ) {
